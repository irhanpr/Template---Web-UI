      ...
      <Table>
        <TableHeader>
          ...
          <TableRow>
            ...
            <TableHeaderColumn tooltip="The ICD Name">Name</TableHeaderColumn>
            <TableHeaderColumn tooltip="The ICD Code">Code</TableHeaderColumn>
            <TableHeaderColumn tooltip="The ICD Type">Type</TableHeaderColumn>
            <TableHeaderColumn tooltip="The Time Created">
              Created
            </TableHeaderColumn>
            <TableHeaderColumn tooltip="The Last Update">
              Last Update
            </TableHeaderColumn>
              ...
              <TableRowColumn>
                {
                  <div className="person">
                    <span title="Edit" className="person__edit">
                      <Link to={"/edit/person/" + person.person_id}>
                        &#9998;
                      </Link>
                    </span>
                    &emsp;
                    <span
                      title="Remove"
                      onClick={this.props.callBacks.removePerson.bind(
                        null,
                        person.person_id,
                        index
                      )}
